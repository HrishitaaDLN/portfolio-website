...
/** SVG robot with CSS float only — avoids extra Framer loops. */
  ...
  return (
    <div className="relative w-full max-w-md mx-auto lg:mx-0">
      <svg viewBox="0 0 320 360" className="w-full h-auto">
        ...
        <rect x="110" y="60" width="100" height="80" rx="12" fill="url(#bodyGrad)" stroke="#00FFE0" strokeWidth="1.5" opacity="0.9" />
        ...
        <rect x="95" y="150" width="130" height="140" rx="8" fill="url(#bodyGrad)" stroke="#7B2FFF" strokeWidth="1" opacity="0.9" />
        {[0, 1, 2, 3, 4].map((i) => (
          <g key={i}>
            <line x1={110 + i * 22} y1="165" x2={110 + i * 22} y2="275" stroke="#00FFE0" strokeWidth="0.5" opacity="0.2" />
            <line x1="105" y1={175 + i * 20} x2="215" y2={175 + i * 20} stroke="#00FFE0" strokeWidth="0.5" opacity="0.2" />
          </g>
        ))}
